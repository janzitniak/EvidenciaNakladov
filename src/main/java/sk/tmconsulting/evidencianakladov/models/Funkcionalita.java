...
public class Funkcionalita implements IFunkcionalita {
    ...
    public void vypisMenu() {
        ...
        // Aplikacia od nas bude pozadovat zadanie kategorie, cize musi najprv zobrazit zoznam kategorii, z ktorych si mozeme vybrat.
    ...
    public void ulozMySQL(Vydavok vydavokObjekt) throws SQLException {
        ...
        statement.setString(1, vydavokObjekt.getPopis());
        statement.setDouble(2, vydavokObjekt.getCena());
        statement.setString(3, vydavokObjekt.getKategoria());
        statement.setDate(4, vydavokObjekt.getDatum());
    ...
    @Override
    public HashMap<String, Double> spocitajVsetkyVydavkyPodlaKategorii() throws SQLException {
    ...
    public void zvolKategoriu() throws SQLException {
        HashMap<String, Double> vsetkyVydavkyPodlaKategorii = spocitajVsetkyVydavkyPodlaKategorii();
        ...
        System.out.println(vsetkyVydavkyPodlaKategorii.get(scn.nextLine()));
    }
